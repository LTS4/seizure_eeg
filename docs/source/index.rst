.. EEG pipeline for reproducible ML documentation master file, created by
   sphinx-quickstart on Wed Sep 27 18:48:06 2023.
...
The first two steps are handled by :mod:`seiz_eeg.preprocess`, whose
...
The creation of clips is provided by :mod:`seiz_eeg.clips` and the
`Dataset` is implemented in :mod:`seiz_eeg.dataset`.
